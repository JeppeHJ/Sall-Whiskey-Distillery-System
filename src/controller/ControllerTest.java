...
class ControllerTest {
    ...
    @Test
    void opretFad() {
        int lagerId = controller.opretLager("Stouby",50);
    ...
    @Test
    void opretTomtFad() {
        int lagerId = controller.opretLager("Barrit",50);
    ...
    void opretFadMedFlereLiterPåfyldtEndStr() {
        int lagerId = controller.opretLager("Horsens",50);
    ...
    void opretFadMedAlkoholprocentHoejereEnd100() {
        int lagerId = controller.opretLager("Aarhus",50);
        Assertions.assertThrows(RuntimeException.class, () -> {
    ...
    @Test
    void opretFadMedFyldtLager() {
        int lagerId = controller.opretLager("Kbh",1);
        controller.opretTomtFad("EXBourbon", 100.0, lagerId);
        controller.opretTomtFad("EXBourbon", 100.0, lagerId);
